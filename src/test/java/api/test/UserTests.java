...
public class UserTests {
	...
	public void testPostUser() {
		...
		Response response= UserEndpoints.creatUser(userPayloads);
...
//		Assert.assertEquals(phone, userPayloads.getPhone());
	...
	public void testGetUser() {
		...
		Response response=UserEndpoints.readUser(userPayloads.getUsername());
		response.then().log().all();
	...
	public void testPutUser() {
		...
		// valdidation
		Response response2=UserEndpoints.readUser(userPayloads.getUsername());
